...
{
    public interface IAcceptedPurchaseIndicatorService
    {
        /// <summary>
        /// Обновление значения показателя
        /// </summary>
        void Update(DateTime startDate, int userId, short storageId, int contractId, int contractorId,
            int accountOrganizationId, int contractorOrganizationId, IEnumerable<AcceptedPurchaseIndicator> indicators);
