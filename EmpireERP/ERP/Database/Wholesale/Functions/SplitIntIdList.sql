/*********************************************************************************************
Процедура: 	SplitIntIdList

Описание:	Получение списка целочисленных кодов сущностей из строки с их перечислением

Параметры:
	@IdList	Строка с перечислением кодов сущностей вида: '12_34_56'
...
IF EXISTS (
  SELECT *
   ...
   WHERE SPECIFIC_SCHEMA = N'dbo'
     AND SPECIFIC_NAME = N'SplitIntIdList'
)
   DROP FUNCTION dbo.SplitIntIdList
GO
