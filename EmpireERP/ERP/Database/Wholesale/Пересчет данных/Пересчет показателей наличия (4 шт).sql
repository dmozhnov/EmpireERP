...
--*****************************************************************************************
	...
	SELECT 
		...
		Count,
		PreviousId
	FROM #T_OutgoingFromExact
	
	DELETE FROM ExactArticleAvailabilityIndicator


	INSERT INTO ExactArticleAvailabilityIndicator (
		Id,
		StartDate,
		EndDate,
		StorageId,
	...
	DELETE FROM IncomingAcceptedArticleAvailabilityIndicator


	INSERT INTO IncomingAcceptedArticleAvailabilityIndicator (
		Id,
		StartDate,
		EndDate,
		StorageId,
