/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.52

  Что нового:
	+ Расширено поле ArticleCertificate.Name до 500 знаков
...
SET @PreviousVersion = '0.9.51' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.52'			-- номер новой версии
...
alter table ArticleCertificate alter column Name varchar(500) not null
GO
