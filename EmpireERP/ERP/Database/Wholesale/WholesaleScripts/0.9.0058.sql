/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.58

  Что нового:
	+ добавлен столбец  "Бухгалтерское название"  в справочник групп товаров 
...
SET @PreviousVersion = '0.9.57' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.58'			-- номер новой версии
...
ALTER TABLE dbo.ArticleGroup ADD NameFor1C varchar(200) NULL
...
ALTER TABLE dbo.ArticleGroup ALTER COLUMN NameFor1C varchar(200) NOT NULL
