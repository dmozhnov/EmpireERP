/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.19

  Что нового:
	* Поле OrdinalNumber в ArticleAccountingPrice больше не nullable
...
SET @PreviousVersion = '0.9.18' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.19'			-- номер новой версии
