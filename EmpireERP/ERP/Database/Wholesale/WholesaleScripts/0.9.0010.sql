/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.10

  Что нового:
	* добавление нового права для системного администратора - просмотр себестоимости (ProductionOrder_ArticlePrimeCostPrintingForm_View)
...
SET @PreviousVersion = '0.9.9' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.10'			-- номер новой версии
