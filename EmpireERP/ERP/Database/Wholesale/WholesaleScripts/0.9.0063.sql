/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.63

  Что нового:
	+ добавлены права на изменение дат оплат и корректировок сальдо
...
SET @PreviousVersion = '0.9.62' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.63'			-- номер новой версии
