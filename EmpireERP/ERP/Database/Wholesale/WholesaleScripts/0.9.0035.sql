/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.35

  Что нового:
	+ Добавлены права на группу отчетов 0007.
...
SET @PreviousVersion = '0.9.34' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.35'			-- номер новой версии
...
INSERT INTO PermissionDistribution (PermissionDistributionTypeId, PermissionId, RoleId) VALUES (3, 24601, 1);
INSERT INTO PermissionDistribution (PermissionDistributionTypeId, PermissionId, RoleId) VALUES (3, 24602, 1);
INSERT INTO PermissionDistribution (PermissionDistributionTypeId, PermissionId, RoleId) VALUES (3, 24603, 1);
