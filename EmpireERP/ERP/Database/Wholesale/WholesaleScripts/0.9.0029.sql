/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.0029

  Что нового:
	+ новое право "Изменение формы оплаты накладной"	
...
SET @PreviousVersion = '0.9.28' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.29'			-- номер новой версии
