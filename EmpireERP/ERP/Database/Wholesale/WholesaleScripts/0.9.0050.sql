/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.50

  Что нового:
	+ права для выполнения операций над приходной накладной задним числом
...
SET @PreviousVersion = '0.9.49' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.50'			-- номер новой версии
