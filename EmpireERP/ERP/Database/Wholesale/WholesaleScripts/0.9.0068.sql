/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.68

  Что нового:
	* Процедура GetReturnFromClientWaybillsForExportTo1C, добавлены 3 параметра :
		...
		ShowReturnsAcceptedByCommissionaires показывать ли возвраты принятые комиссионерами(получатели возвратов) от клиентов
---------------------------------------------------------------------------------------*/
...
SET @PreviousVersion = '0.9.67' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.68'			-- номер новой версии
