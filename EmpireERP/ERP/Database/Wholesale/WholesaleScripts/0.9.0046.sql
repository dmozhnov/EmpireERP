/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.46

  Что нового:
	* Изменен тип данных линейных размеров упаковки товара с decimal на int
...
SET @PreviousVersion = '0.9.45' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.46'			-- номер новой версии
...
alter table Article alter column PackHeight int NOT NULL
...
alter table Article alter column PackLength int NOT NULL
...
alter table Article alter column PackWidth int NOT NULL
