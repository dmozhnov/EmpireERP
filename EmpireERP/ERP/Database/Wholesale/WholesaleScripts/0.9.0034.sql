/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.34

  Что нового:
	+ Добавлены права для отчета 0008 "Реест накладных"	
...
SET @PreviousVersion = '0.9.33' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.34'			-- номер новой версии
