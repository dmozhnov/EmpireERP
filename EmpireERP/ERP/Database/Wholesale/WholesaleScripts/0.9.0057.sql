/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.57

  Что нового:
	+ добавлен признак-столбец для номера ГТД в приходную накладную 
...
SET @PreviousVersion = '0.9.56' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.57'			-- номер новой версии
...
ALTER TABLE ReceiptWaybill ADD IsCustomsDeclarationNumberFromReceiptWaybill BIT not null
	constraint IX_ReceiptWaybill_IsCustomsDeclarationNumberFromReceiptWaybill DEFAULT 0
...
ALTER TABLE ReceiptWaybill drop IX_ReceiptWaybill_IsCustomsDeclarationNumberFromReceiptWaybill
