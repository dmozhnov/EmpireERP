/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.54

  Что нового:
	* переименованы поля позиции РЦ, отвечающие за хранение признака ошибки расчета по заданному правилу
...
SET @PreviousVersion = '0.9.53' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.54'			-- номер новой версии
...
sp_RENAME 'ArticleAccountingPrice.UsedDefaultLastDigitRule', 'ErrorLastDigitCalculation' , 'COLUMN'
...
sp_RENAME 'ArticleAccountingPrice.UsedDefaultAccountingPriceCalcRule', 'ErrorAccountingPriceCalculation' , 'COLUMN'
