/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.43

  Что нового:
	+ Права для отчета 0009
...
SET @PreviousVersion = '0.9.42' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.43'			-- номер новой версии
