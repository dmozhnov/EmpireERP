/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.7

  Что нового:
	+ в таблицу AccountingPriceListWaybillTaking добавлен столбец RevaluationDate (дата осуществления переоценки по привязки)
...
SET @PreviousVersion = '0.9.6' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.7'			-- номер новой версии
...
GO
	...
	ALTER TABLE AccountingPriceListWaybillTaking
		ADD RevaluationDate DATETIME NULL
