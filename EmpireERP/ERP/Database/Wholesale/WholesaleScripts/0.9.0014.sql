/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.14

  Что нового:
	+ Права на работу со справочником должности сотрудника, НДС, Организационно-правовые формы
...
SET @PreviousVersion = '0.9.13' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.14'			-- номер новой версии
