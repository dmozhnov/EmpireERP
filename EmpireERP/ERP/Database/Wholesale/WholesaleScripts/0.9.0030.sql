/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.30

  Что нового:
	+ добавлено право на просмотр 6-го отчета "Взаиморасчеты с клиентами"
...
SET @PreviousVersion = '0.9.29' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.30'			-- номер новой версии
