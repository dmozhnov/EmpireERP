/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.37

  Что нового:
	* исправлены длинны полей в истории задачи
	* поле «Тема задачи» в истории сделано not null
...
SET @PreviousVersion = '0.9.36' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.37'			-- номер новой версии
...
alter table TaskHistoryItem alter column  Topic VARCHAR(200) not null
...
alter table dbo.[TaskHistoryItem] alter column  Description VARCHAR(8000) not null
