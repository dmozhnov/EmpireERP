/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.8

  Что нового:
	* Переименовано поле в таможенном листе Number -> CustomsDeclarationNumber
...
SET @PreviousVersion = '0.9.7' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.8'			-- номер новой версии
...
EXEC sp_rename 'ProductionOrderCustomsDeclaration.Number', 'CustomsDeclarationNumber';
...
ALTER TABLE dbo.[ProductionOrderBatch] DROP COLUMN [ProductionOrderCustomsDeclarationId];
