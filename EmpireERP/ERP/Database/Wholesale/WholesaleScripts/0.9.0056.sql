/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.56

  Что нового:
	* Поле "плановый платеж" для оплаты по заказу сделано необязательным
...
SET @PreviousVersion = '0.9.55' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.56'			-- номер новой версии
...
alter table ProductionOrderPayment alter column ProductionOrderPlannedPaymentId UNIQUEIDENTIFIER null
