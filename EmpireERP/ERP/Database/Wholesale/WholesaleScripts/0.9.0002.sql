...
DECLARE @PreviosVersion varchar(15),	-- номер предыдущей версии
...
SET @PreviosVersion = '0.9.1' 			-- номер ПРЕДЫДУЩЕЙ версии
	...
	ELSE
		...
		BEGIN
			PRINT 'Обновить базу данных ' + @DataBaseName + ' до версии ' + @NewVersion + 
				' можно только из версии  ' + @PreviosVersion +
