/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.64

  Что нового:
	+ таблица для ведения журнала событий (ошибок) системы
...
SET @PreviousVersion = '0.9.63' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.64'			-- номер новой версии
