/*---------------------------------------------------------------------------------------
  Скрипт для обновления базы до версии 0.9.24

  Что нового:
	- удалено право на изменение договора по сделке (3507)	
	+ добавлены новые права "Создание договора по сделке" (4201) и "Редактирование договора по сделке" (4202)
...
SET @PreviousVersion = '0.9.23' 			-- номер ПРЕДЫДУЩЕЙ версии
SET @NewVersion     = '0.9.24'			-- номер новой версии
...
delete from PermissionDistribution where PermissionId = 3507
