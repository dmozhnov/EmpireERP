...
{
    public class ReturnFromClientBySaleShippingDateIndicatorMap : ClassMap<ReturnFromClientBySaleShippingDateIndicator>
    {
        public ReturnFromClientBySaleShippingDateIndicatorMap()
        {
