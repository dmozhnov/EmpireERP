...
{
    public class OutgoingAcceptedFromExactArticleAvailabilityIndicatorMap : ClassMap<OutgoingAcceptedFromExactArticleAvailabilityIndicator>
    {
        public OutgoingAcceptedFromExactArticleAvailabilityIndicatorMap()
        {
