...
<div style="width: 700px; padding: 0px 10px;">
    ...
    <table class="display_table">
        <tr>
            ...
            <td class="row_title">
                <%: Html.LabelFor(model => model.MovementMarkupSum) %>:
            </td>
            <td>
                <%: Model.MovementMarkupPercent %> % || <%: Model.MovementMarkupSum %> р.
            </td>
        </tr>
        <tr>
            <td class="row_title">
                <%: Html.LabelFor(model => model.RecipientAccountingPrice)%>:
            </td>
            <td>
                <span id="RecipientAccountingPrice"><%: Model.RecipientAccountingPrice %></span> р.
