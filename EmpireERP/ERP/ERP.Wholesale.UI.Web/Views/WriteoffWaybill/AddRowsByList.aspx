...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%= Html.PageTitle("ExpenditureWaybill", "Добавление позиций в накладную списания", Model.Name)%>
    ...
    <% Html.RenderPartial("WriteoffWaybillRowGrid", Model.RowGrid); %>
